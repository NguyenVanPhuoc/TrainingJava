<header class="flex items-center justify-between mb-4">
	...
	<div class="relative">
		<img src="${not empty principal.avatar ? '/uploads/' += principal.avatar : 'https://picsum.photos/40'}"
			alt="User Avatar" class="rounded-full cursor-pointer" onclick="toggleMenu()" id="avatar" />

		<div id="logoutMenu"
			class="absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow-lg hidden z-50">
